-- Healthcare Platform Unified Schema
-- Optimized for PostgreSQL with best practices
...
CREATE INDEX IF NOT EXISTS idx_availability_slots_clinic_id ON availability_slots(clinic_id);
